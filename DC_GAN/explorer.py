...
from DC_GAN.train import Generator, Discriminator, opt
from DC_GAN.saver import save_ecg_to_explore, save_ecgs_varied_one_plot, save_ecgs_varied_several_plots
...
if __name__ == "__main__":
    ...
    draw_variation_at_i_one_latent(generator, 12)
    draw_variation_at_i_one_latent(generator, 13)
    draw_variation_at_i_one_latent(generator, 15)
    draw_variation_at_i_one_latent(generator, 17)