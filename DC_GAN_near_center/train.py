...
from DC_GAN_near_center.create_dataset import ECGDataset
from DC_GAN_near_center.saver import save_batch_to_images, save_models, save_training_curves
...
#------------------------
parser.add_argument("--step_size", type=int, default=1, help="num discrets in one step")
parser.add_argument("--max_steps_left", type=int, default=20, help="num steps from patch center, allowed for the moving complex")
